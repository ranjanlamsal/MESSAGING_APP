# Generated by Django 5.1.5 on 2025-02-15 07:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('messageboard', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='Message_board.messageboard')),
            ],
            options={
                'ordering': ['-created'],
            },
